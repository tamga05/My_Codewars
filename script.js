...
// Duck Duck Goose. Task: Given an array of Player objects (an array of associative arrays in PHP) and an index (1-based), return the name of the chosen
...
// Write a function howMuchWater (JS)/how_much_water (Python and Ruby) to work out how much water is needed if you have a clothes amount of clothes. The
// function will accept 3 arguments: - water, load (or max_loading Ruby) and clothes.
...
// L1: Set Alarm. Write a function named setAlarm which receives two parameters. The first parameter, employed, is true whenever you are employed and the second parameter, vacation is true whenever you are on vacation.
...
// Parse nice int from char problem. You ask a small girl,"How old are you?" She always says, "x years old", where x is a random number between 0 and 9.
...
// Grader. Create a function that takes a number as an argument and returns a grade based on that number.
//
// Score	Grade
