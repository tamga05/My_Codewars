...
// Grasshopper - Grade book. Grade book
...
// Find the Integral. Create a function that finds the integral of the expression passed.
...
// Contamination #1 -String-. An AI has infected a text with a character!!
...
// Geometry Basics: Distance between points in 2D. This series of katas will introduce you to basics of doing geometry with computers.
...
// The falling speed of petals. When it's spring Japanese cherries blossom, it's called "sakura" and it's admired a lot. The petals start to fall in late April.
...
// Total amount of points. Our football team has finished the championship.
...
// Age Range Compatibility Equation. Everybody knows the classic "half your age plus seven" dating rule that a lot of people follow (including myself). It's the 'recommended' age range in which to date someone.
...
// Price of Mangoes. There's a "3 for 2" (or "2+1" if you like) offer on mangoes. For a given quantity and price (per mango), calculate the total cost of the mangoes.
